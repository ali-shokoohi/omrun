...
urlpatterns = [
    ...
    path('tasks/', views.Tasks_list.as_view(), name='projects list'),
    path('tasks/<int:pk>/', views.Tasks_detial.as_view(), name='project detail'),
    path('todo/', views.ToDo_list.as_view(), name='plans list'),
    path('todo/<int:pk>/', views.ToDo_detail.as_view(), name='plan detail'),
